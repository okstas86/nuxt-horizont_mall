<template>
			...
			<div class="md:flex gap-4 justify-between w-full">
				...
				<div class="md:w-[50%] pt-4">
					<div class="text-lg font-semibold text-[#282828]">
						Horisont Mall Multi-Language Sites
					</div>
					<div class="text-[#999999] text-sm">
			...
			<div class="md:flex gap-4 justify-between w-full">
				<div class="md:w-[50%] pt-4">
					...
					<div class="text-[#999999] text-sm">
						...
						Blog, Seller Portal, BLACK FRIDAY, Horizon Mall Assistant
					</div>
				</div>
				<div class="md:w-[50%] pt-4">
					<div class="text-lg font-semibold text-[#282828]">Horizon Group</div>
					<div class="text-[#999999] text-sm">
						DreamGroup Website, FantasyCorp, Allpay, Fliggy, DreamCloud,
						DreamInternational, DreamTelecom, DingTalk, Juhuasuan, Taobao
						Marketplace, Tmall, Taobao Global, DreamOS, 1688
					</div>
				</div>
			</div>
		</div>
	...
	<div id="FooterSub" class="w-full bg-[#333333] text-sm text-gray-400">
		<div class="max-w-[1200px] mx-auto p-4">
			...
			(Transactions) - User Information Legal Enquiry Guide ©️2010-2022 Horizon
